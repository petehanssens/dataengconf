              ...
              <div className="max-w-md mx-auto px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:p-0">
                <div className="aspect-w-10 aspect-h-6 sm:aspect-w-2 sm:aspect-h-1 lg:aspect-w-1">
                  <img
                    ...
                    src="/images/hackathon/trophy.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div className="relative bg-indigo-600 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
              ...
              <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                ...
                <p className="text-lg text-white">
                  Win bragging rights in your local city as the number one Hacker... win a trophy to prove it.
                </p>
                <a
                  ...
                  href="https://www.tickettailor.com/events/dataengbytes/664753"
                >
                  Hackathon tickets
                </a>
              </div>
