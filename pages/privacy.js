...
export default function Privacy() {
  return (
    ...
    <div class="row">
        ...
        <p className="text-3xl">Privacy and Legal</p>
        <p className="text-2xl">General</p>
            ...
            <p className="text-2xl">Trademarks</p>
            ...
            <p className="text-2xl">Copyrights</p>
            ...
            <p className="text-2xl">Certain disclaimers</p>
            ...
            <p className="text-2xl">Confidential information</p>
            ...
            <p className="text-2xl">Global availability</p>
            ...
            <p className="text-2xl">Linking to this site</p>
            ...
            <p className="text-2xl">Use of cookies</p>
            ...
            <p className="text-2xl">Jurisdiction</p>
            ...
            <p className="text-2xl">DISCLAIMER OF WARRANTY</p>
            ...
            <p className="text-2xl">LIMITATION OF LIABILITY</p>
